package com.octopod.switchcore.commands;
...
public class ServerCommands
{
	...
	public void serverList(MinecraftCommandSource source)
	{
		...
		for(String servername: servernames)
		{
			...
			if(server.isExternal())
			{
				...
				).run("/server " + server.getServerIdentifier());
			} else {
				if(online)
				{
	...
	{
		final SwitchPacket message = new PacketOutServerPing(id);
	...
	{
		final SwitchPacket message = new PacketOutServerValue(value);
	...
	{
		final SwitchPacket message = new PacketOutServerDiscover();
